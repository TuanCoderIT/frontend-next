            ...
            <div className="max-w-md mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">
                        Mua tokens để mở khóa tính năng premium
                    </p>
                </div>
                    ...
                    {tokenAmount > 0 && (
                        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 mb-6">
                            <div className="flex justify-between items-center">
                                <span className="text-gray-700 font-medium">Tổng giá tiền:</span>
                                <span className="text-2xl font-bold text-green-600">
                                    {totalPrice.toLocaleString('vi-VN')} VND
                                </span>
                            </div>
                            <div className="text-sm text-gray-500 mt-1">
                                Tỉ giá: 1 token = {tokenPrice.toLocaleString('vi-VN')} VND
                            </div>
                        </div>
                    )}
                ...
                {showSuccess && (
                    <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-green-800 font-medium">Thanh toán đã được khởi tạo thành công!</p>
                                <p className="text-green-600 text-sm">Chuyển hướng đến cổng thanh toán...</p>
                            </div>
                        </div>
                    </div>
                )}
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h3 className="text-blue-900 font-medium mb-1">Thông tin thanh toán</h3>
                            <p className="text-blue-700 text-sm">
                                Chúng tôi chấp nhận thanh toán qua VNPay và Stripe. Thanh toán của bạn được bảo mật và được mã hóa.
